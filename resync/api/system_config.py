    ...
    return [
        ...
        ConfigCategory(
            ...
            fields=[
                ...
                ConfigField(
                    name="rate_limit_dashboard_per_minute",
                    value=settings.rate_limit_dashboard_per_minute,
                    type="int",
                ...
                ConfigField(
                    name="rate_limit_error_handler_per_minute",
                    value=settings.rate_limit_error_handler_per_minute,
                    type="int",
        ...
        ConfigCategory(
            ...
            fields=[
                ...
                ConfigField(
                    name="tws_teams_webhook_url",
                    value=settings.tws_teams_webhook_url or "",
                    type="string",
        ...
        ConfigCategory(
            name="server",
            display_name="Server & Project",
            description="Server configuration and project information",
            icon="fa-server",
            fields=[
                ConfigField(
                    name="server_host",
                ...
                ConfigField(
                    ...
                    default="HCL Workload Automation AI Interface",
                    requires_restart=False,
                    category="server",
                    sensitive=False,
                ),
                ConfigField(
                    name="environment",
                    value=str(settings.environment.value) if hasattr(settings.environment, 'value') else str(settings.environment),
                    type="string",
        ...
        ConfigCategory(
            name="cors",
            display_name="CORS Settings",
            description="Cross-Origin Resource Sharing configuration",
            icon="fa-globe",
            fields=[
                ConfigField(
                    name="cors_allowed_origins",
                    value=",".join(settings.cors_allowed_origins) if settings.cors_allowed_origins else "*",
                    type="string",
                ...
                ConfigField(
                    ...
                    value=settings.cors_allow_credentials,
                    type="bool",
                ...
                ConfigField(
                    ...
                    value=",".join(settings.cors_allow_methods) if settings.cors_allow_methods else "*",
                    type="string",
                ...
                ConfigField(
                    ...
                    value=",".join(settings.cors_allow_headers) if settings.cors_allow_headers else "*",
                    type="string",
        ...
        ConfigCategory(
            name="tws_connection",
            display_name="TWS Connection",
            description="HCL Workload Automation connection settings",
            icon="fa-plug",
            fields=[
                ConfigField(
                    name="tws_mock_mode",
                    value=settings.tws_mock_mode,
                    type="bool",
                    description="Use mock TWS client for testing",
                    default=True,
                    requires_restart=True,
                    category="tws_connection",
                    sensitive=False,
                ),
                ConfigField(
                    name="tws_host",
                    value=settings.tws_host or "",
                    type="string",
                    description="TWS server hostname",
                    default="",
                    requires_restart=True,
                    category="tws_connection",
                    sensitive=False,
                ...
                ConfigField(
                    name="tws_port",
                    value=settings.tws_port or 31111,
                    type="int",
                    description="TWS server port",
                    default=31111,
                    min_value=1,
                    max_value=65535,
                    requires_restart=True,
                ...
                ConfigField(
                    name="tws_base_url",
                    value=settings.tws_base_url,
                    type="string",
                    description="TWS base URL",
                    default="http://localhost:31111",
                    requires_restart=True,
                    category="tws_connection",
                    sensitive=False,
                ),
                ConfigField(
                    name="tws_user",
                    value=settings.tws_user or "",
                    type="string",
                    description="TWS username",
                    default="",
                    requires_restart=False,
                    category="tws_connection",
                    sensitive=True,
                ...
                ConfigField(
                    name="tws_request_timeout",
                    value=settings.tws_request_timeout,
                    type="float",
                ...
                ConfigField(
                    name="tws_verify",
                    value=settings.tws_verify if isinstance(settings.tws_verify, bool) else str(settings.tws_verify),
                    type="bool",
                ...
                ConfigField(
                    name="tws_ca_bundle",
                    value=settings.tws_ca_bundle or "",
                    type="string",
        ...
        ConfigCategory(
            name="redis",
            display_name="Redis Configuration",
            description="Redis connection and pool settings",
            icon="fa-database",
            fields=[
                ConfigField(
                    name="redis_url",
                ...
                ConfigField(
                    name="redis_min_connections",
                    value=settings.redis_min_connections,
                    type="int",
                    description="Minimum Redis connections",
                    default=1,
                    min_value=1,
                    max_value=100,
                    requires_restart=True,
                ...
                ConfigField(
                    ...
                    value=settings.redis_max_connections,
                    type="int",
                ...
                ConfigField(
                    ...
                    value=settings.redis_pool_idle_timeout,
                    type="int",
                ...
                ConfigField(
                    name="redis_pool_connect_timeout",
                    value=settings.redis_pool_connect_timeout,
                    type="int",
                ...
                ConfigField(
                    ...
                    value=settings.redis_health_check_interval,
                    type="int",
                ...
                ConfigField(
                    name="redis_pool_health_check_interval",
                    value=settings.redis_pool_health_check_interval,
                    type="int",
                    description="Pool health check interval (seconds)",
                    default=60,
                    min_value=10,
                    max_value=300,
                    requires_restart=False,
                ...
                ConfigField(
                    name="redis_pool_max_lifetime",
                    value=settings.redis_pool_max_lifetime,
                    type="int",
                    description="Maximum connection lifetime (seconds)",
                    default=1800,
                    min_value=300,
                    max_value=7200,
                    requires_restart=True,
                ...
                ConfigField(
                    name="redis_max_startup_retries",
                    value=settings.redis_max_startup_retries,
                    type="int",
                    description="Maximum startup retries",
                    default=3,
                    min_value=1,
                    max_value=10,
                    requires_restart=True,
        ...
        ConfigCategory(
            ...
            fields=[
                ...
                ConfigField(
                    ...
                    value=settings.db_pool_idle_timeout,
                    type="int",
                    description="Idle connection timeout (seconds)",
                    default=1200,
                    min_value=60,
                ...
                ConfigField(
                    name="db_pool_health_check_interval",
                    value=settings.db_pool_health_check_interval,
                    type="int",
                    description="Health check interval (seconds)",
                    default=60,
                    min_value=10,
                ...
                ConfigField(
                    ...
                    value=settings.db_pool_max_lifetime,
                    type="int",
                    description="Maximum connection lifetime (seconds)",
                    default=1800,
                    min_value=300,
        ...
        ConfigCategory(
            name="http_pool",
            display_name="HTTP Pool",
            description="HTTP connection pool for external requests",
            icon="fa-network-wired",
            fields=[
                ConfigField(
                    name="http_pool_min_size",
                    value=settings.http_pool_min_size,
                    type="int",
                    description="Minimum HTTP connections",
                    default=10,
                    min_value=1,
                    max_value=100,
                    requires_restart=True,
                ...
                ConfigField(
                    name="http_pool_max_size",
                    value=settings.http_pool_max_size,
                    type="int",
                ...
                ConfigField(
                    name="http_pool_idle_timeout",
                    value=settings.http_pool_idle_timeout,
                    type="int",
                    description="Idle connection timeout (seconds)",
                    default=300,
                    min_value=60,
                ...
                ConfigField(
                    name="http_pool_connect_timeout",
                    value=settings.http_pool_connect_timeout,
                    type="int",
                    description="Connection timeout (seconds)",
                    default=10,
                    min_value=1,
                ...
                ConfigField(
                    name="http_pool_health_check_interval",
                    value=settings.http_pool_health_check_interval,
                    type="int",
                    description="Health check interval (seconds)",
                    default=60,
                    min_value=10,
                ...
                ConfigField(
                    name="http_pool_max_lifetime",
                    value=settings.http_pool_max_lifetime,
                    type="int",
                    description="Maximum connection lifetime (seconds)",
                    default=1800,
                    min_value=300,
        ...
        ConfigCategory(
            ...
            description="LangFuse observability and tracing",
            icon="fa-chart-line",
            fields=[
                ConfigField(
                    name="langfuse_enabled",
                    value=settings.langfuse_enabled,
                    type="bool",
                ...
                ConfigField(
                    ...
                    value=settings.langfuse_public_key if settings.langfuse_public_key else "",
                    type="string",
                ...
                ConfigField(
                    name="langfuse_trace_sample_rate",
                    value=settings.langfuse_trace_sample_rate,
                    type="float",
                    description="Trace sample rate (0.0 to 1.0)",
                    default=1.0,
                    min_value=0.0,
                    max_value=1.0,
                    requires_restart=False,
        ...
        ConfigCategory(
            ...
            description="LangGraph workflow settings",
            icon="fa-project-diagram",
            fields=[
                ConfigField(
                    name="langgraph_enabled",
                    value=settings.langgraph_enabled,
                    type="bool",
                ...
                ConfigField(
                    name="langgraph_checkpoint_ttl_hours",
                    value=settings.langgraph_checkpoint_ttl_hours,
                    type="int",
                    description="Checkpoint TTL (hours)",
                    default=24,
                    min_value=1,
                    max_value=168,
                    requires_restart=False,
                ...
                ConfigField(
                    name="langgraph_max_retries",
                    value=settings.langgraph_max_retries,
                    type="int",
                ...
                ConfigField(
                    name="langgraph_require_approval",
                    value=settings.langgraph_require_approval,
                    type="bool",
        ...
        ConfigCategory(
            name="age_graph",
            display_name="Apache AGE Graph",
            description="Knowledge graph settings",
            icon="fa-sitemap",
            fields=[
                ConfigField(
                    name="age_graph_name",
                    value=settings.age_graph_name,
                    type="string",
                    description="Graph name in Apache AGE",
                    default="resync_knowledge",
                    requires_restart=True,
                    category="age_graph",
                    sensitive=False,
                ),
                ConfigField(
                    name="age_max_traversal_depth",
                    value=settings.age_max_traversal_depth,
                    type="int",
        ...
        ConfigCategory(
            name="cache_advanced",
            display_name="Cache Advanced",
            description="Advanced cache settings",
            icon="fa-memory",
            fields=[
                ConfigField(
                    name="cache_hierarchy_num_shards",
                    value=settings.cache_hierarchy_num_shards,
                    type="int",
                    ...
                    max_value=64,
                    requires_restart=True,
                    category="cache_advanced",
                    sensitive=False,
                ),
                ConfigField(
                    name="cache_hierarchy_max_workers",
                    value=settings.cache_hierarchy_max_workers,
                    type="int",
                    description="Maximum worker threads for cache",
                    default=4,
                    min_value=1,
                    max_value=32,
                    requires_restart=True,
                ...
                ConfigField(
                    name="enable_cache_swr",
                    value=settings.enable_cache_swr,
                    type="bool",
                ...
                ConfigField(
                    name="cache_ttl_jitter_ratio",
                    value=settings.cache_ttl_jitter_ratio,
                    type="float",
                    description="TTL jitter ratio (0.0 to 0.5)",
                    default=0.1,
                    min_value=0.0,
                    max_value=0.5,
                    requires_restart=False,
                ...
                ConfigField(
                    name="enable_cache_mutex",
                    value=settings.enable_cache_mutex,
                    type="bool",
                    description="Enable cache mutex (prevent stampede)",
                    default=True,
                    requires_restart=False,
                    category="cache_advanced",
                    sensitive=False,
                ...
                ConfigField(
                    name="robust_cache_enable_wal",
                    value=settings.robust_cache_enable_wal,
                    type="bool",
                    description="Enable Write-Ahead Logging for cache",
                    default=False,
                    requires_restart=True,
                    category="cache_advanced",
                    sensitive=False,
