...
class DatabasePrivilegeManager:
    ...
    def get_user_role(self, session_token: str) -> Optional[UserRole]:
        """
    ...
    def get_user_permissions(self, session_token: str) -> Optional[Set[DatabasePermission]]:
        """
...
_privilege_manager: Optional[DatabasePrivilegeManager] = None
