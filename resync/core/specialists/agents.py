...
class BaseSpecialist:
    ...
    async def process(self, query: str, context: Optional[Dict] = None) -> SpecialistResponse:
        """
...
class JobAnalystAgent(BaseSpecialist):
    ...
    def __init__(self, config: Optional[SpecialistConfig] = None, **kwargs):
...
_specialist_team_instance: Optional[TWSSpecialistTeam] = None


def get_specialist_team() -> Optional[TWSSpecialistTeam]:
