...
class DataStructureValidator:
    ...
    def validate_dict_structure(
        ...
        key_validator: Optional[str] = None
    ) -> List[str]:
        """
        ...
        if key_validator:
            ...
            for key in data.keys():
                if key_validator == "metadata" and not self.validator.validate_metadata_key(key):
                    invalid_keys.append(key)
                elif key_validator == "config" and not self.validator.validate_config_key(key):
                    invalid_keys.append(key)
                elif key_validator == "json_web" and not self.validator.validate_json_web_key(key):
                    invalid_keys.append(key)
    ...
    def validate_list_structure(
        self, data: List[Any], 
        item_validator: Optional[str] = None,
...
_global_validator: Optional[OptimizedValidator] = None
