...
from resync.core.continual_learning.feedback_store import (
    get_feedback_store, FeedbackRating
)
...
from resync.core.continual_learning.audit_to_kg_pipeline import (
    get_audit_to_kg_pipeline, AuditResult
)
from resync.core.continual_learning.context_enrichment import (
    get_context_enricher, EnrichmentResult
)
from resync.core.continual_learning.active_learning import (
    get_active_learning_manager, ActiveLearningDecision, ReviewReason
)
...
class ContinualLearningOrchestrator:
    ...
    def __init__(
        self,
        feedback_retriever: Optional[FeedbackAwareRetriever] = None,
    ...
    ) -> Tuple[ActiveLearningDecision, Optional[str]]:
        """
...
# Singleton instance
_orchestrator: Optional[ContinualLearningOrchestrator] = None
