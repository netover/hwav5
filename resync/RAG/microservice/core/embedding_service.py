...
class MultiProviderEmbeddingService(Embedder):
    ...
    def _infer_dimension(self, model: str) -> Optional[int]:
        ...
        # Cohere models
        elif "embed-english-v3" in model_lower:
            return 1024
        elif "embed-multilingual-v3" in model_lower:
            return 1024
        elif "embed-english-light-v3" in model_lower:
            return 384
        
        # Voyage models
        elif "voyage-2" in model_lower or "voyage-large-2" in model_lower:
            return 1024
        elif "voyage-code-2" in model_lower:
            return 1536
        ...
        # Mistral
        elif "mistral-embed" in model_lower:
            return 1024
...
def create_embedding_service(
    provider: Union[str, EmbeddingProvider] = EmbeddingProvider.AUTO,
    model: Optional[str] = None,
    **kwargs,
