...
class TestTWSRelationTypes:
    ...
    def test_relation_types_count(self):
        ...
        from resync.knowledge.retrieval.tws_relations import TWSRelationType
    ...
    def test_relation_categories(self):
        ...
        from resync.knowledge.retrieval.tws_relations import get_relation_types_info
        ...
        for category in expected_categories:
            assert category in info["categories"], f"Missing category: {category}"
            assert len(info["categories"][category]) > 0, f"Empty category: {category}"

    def test_node_types_count(self):
        """Verify node types."""
        from resync.knowledge.retrieval.tws_relations import TWSNodeType

        assert len(TWSNodeType) >= 8, f"Expected 8+ node types, got {len(TWSNodeType)}"

    def test_tws_node_creation(self):
        """Test TWSNode creation."""
        from resync.knowledge.retrieval.tws_relations import TWSNode, TWSNodeType
    ...
    def test_tws_relation_creation(self):
        ...
        from resync.knowledge.retrieval.tws_relations import TWSRelation, TWSRelationType
    ...
    def test_relation_builder(self):
        ...
        from resync.knowledge.retrieval.tws_relations import TWSRelationBuilder, TWSRelationType

        builder = TWSRelationBuilder(tenant_id="tenant_a")

        relations = (
            builder.job_depends_on("JOB_B", "JOB_A")
    ...
    # test_cypher_generation removed in v5.9.3 - Apache AGE was never implemented
...
class TestTWSGraphExpander:
    ...
    def test_expander_initialization(self):
        ...
        from resync.knowledge.retrieval.tws_expander import (
    ...
    def test_expansion_stats(self):
        ...
        from resync.knowledge.retrieval.tws_expander import ExpansionStats
