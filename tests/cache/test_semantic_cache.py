...
class TestSemanticCache:
    ...
    async def test_cache_initialization(self, mock_redis):
        ...
        with patch("resync.core.cache.semantic_cache.get_redis_client", return_value=mock_redis):
            with patch(
                "resync.core.cache.semantic_cache.check_redis_stack_available",
...
class TestLLMCacheWrapper:
    ...
    async def test_cached_llm_call_miss(self):
        ...
        from resync.core.cache.semantic_cache import CacheResult, SemanticCache
        ...
        with patch(
            "resync.core.cache.llm_cache_wrapper.get_semantic_cache", return_value=mock_cache
        ):
