...
class TestChatMessageSecurity:
    ...
    def test_valid_message_creation(self):
        ...
        # Arrange & Act
        message = ChatMessage(
            content="Hello, how can I help you?", sender="user123", message_type=MessageType.TEXT
        )
    ...
    def test_reject_empty_content(self):
        ...
        with pytest.raises(ValidationError) as exc_info:
            ChatMessage(content="", sender="user123")

        assert "Message content cannot be empty" in str(exc_info.value) or "too_short" in str(
            exc_info.value
        )
    ...
    def test_reject_script_injection(self):
        ...
        for content in malicious_contents:
            with pytest.raises(ValidationError) as exc_info:
                ChatMessage(content=content, sender="user123")

            assert (
                "malicious" in str(exc_info.value).lower()
                or "script" in str(exc_info.value).lower()
            )
...
class TestChatMessageLimits:
    ...
    def test_message_within_length_limits(self):
        ...
        # Act
        message = ChatMessage(content=content, sender="user123")
...
class TestMessageTypes:
    ...
    def test_all_message_types_valid(self):
        ...
        for msg_type in message_types:
            message = ChatMessage(content="Test message", sender="user123", message_type=msg_type)
            assert message.message_type == msg_type

    def test_default_message_type_is_text(self):
        """Teste que tipo padrão é TEXT"""
        # Arrange & Act
        message = ChatMessage(content="Test", sender="user123")
    ...
    def test_reject_invalid_message_type(self):
        ...
        with pytest.raises(ValidationError):
            ChatMessage(content="Test", sender="user123", message_type="invalid_type")
...
class TestMessageStatus:
    ...
    def test_all_status_values_valid(self):
        ...
        for status in statuses:
            message = ChatMessage(content="Test", sender="user123", status=status)
    ...
    def test_status_transition_sent_to_delivered(self):
        ...
        # Arrange
        message = ChatMessage(content="Test", sender="user123", status=MessageStatus.SENT)
...
class TestChatMessageMetadata:
    ...
    def test_message_with_recipient(self):
        ...
        message = ChatMessage(content="Test", sender="user123", recipient="agent-tws")
    ...
    def test_message_with_session_id(self):
        ...
        # Arrange & Act
        message = ChatMessage(content="Test", sender="user123", session_id="session-abc-123")
    ...
    def test_message_with_metadata(self):
        ...
        # Arrange
        metadata = {"client": "web", "version": "1.0.0", "language": "pt-BR"}

        # Act
        message = ChatMessage(content="Test", sender="user123", metadata=metadata)
    ...
    def test_message_with_parent_id(self):
        ...
        # Arrange & Act
        message = ChatMessage(
            content="Reply to previous", sender="user123", parent_message_id="msg-123"
        )
    ...
    def test_priority_range_validation(self):
        ...
        for priority in valid_priorities:
            message = ChatMessage(content="Test", sender="user123", priority=priority)
        ...
        for priority in invalid_priorities:
            with pytest.raises(ValidationError):
                ChatMessage(content="Test", sender="user123", priority=priority)
...
class TestChatMessageTimestamp:
    ...
    def test_custom_timestamp(self):
        ...
        # Act
        message = ChatMessage(content="Test", sender="user123", timestamp=custom_time)
...
class TestChatMessageModelConfig:
    ...
    def test_reject_extra_fields(self):
        ...
        # Arrange & Act & Assert
        with pytest.raises(ValidationError) as exc_info:
            ChatMessage(content="Test", sender="user123", extra_field="not allowed")
...
class TestChatMessageEdgeCases:
    ...
    def test_unicode_characters_in_content(self):
        ...
        # Act
        message = ChatMessage(content=unicode_content, sender="user123")
    ...
    def test_newlines_in_content(self):
        ...
        # Act
        message = ChatMessage(content=content_with_newlines, sender="user123")
    ...
    def test_special_characters_in_content(self):
        ...
        # Act
        message = ChatMessage(content=special_chars, sender="user123")
...
class TestChatMessageSerialization:
    ...
    def test_message_from_dict(self):
        ...
        # Arrange
        message_dict = {"content": "Test message", "sender": "user123", "message_type": "text"}
