...
# Helper functions for optional dependency checks
def _has_bs4() -> bool:
...
class TestMultiProviderEmbeddingService:
    ...
    def test_provider_enum(self):
        ...
        from resync.knowledge.ingestion.embedding_service import EmbeddingProvider
...
class TestDocumentParser:
    ...
    def test_import(self):
        ...
        from resync.knowledge.ingestion.document_parser import (
            DocumentChunk,
            DocumentParser,
            DocumentType,
            HTMLParser,
    ...
    def test_document_type_enum(self):
        ...
        from resync.knowledge.ingestion.document_parser import DocumentType
...
class TestHTMLParser:
    ...
    def test_html_parser_init(self):
        ...
        from resync.knowledge.ingestion.document_parser import HTMLParser
...
class TestPDFParser:
    ...
    def test_pdf_parser_init(self):
        ...
        from resync.knowledge.ingestion.document_parser import PDFParser
