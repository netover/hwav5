...
class TestClientErrors:
    ...
    def test_rate_limit_error(self):
        ...
        exc = RateLimitError(
            message="Too many requests", retry_after=60, details={"limit": 100, "window": "1h"}
        )
...
class TestServerErrors:
    ...
    def test_internal_error(self):
        ...
        exc = InternalError(message="Unexpected error occurred", details={"component": "database"})
    ...
    def test_service_unavailable_error(self):
        ...
        exc = ServiceUnavailableError(message="Service temporarily down", retry_after=300)
    ...
    def test_circuit_breaker_error(self):
        ...
        exc = CircuitBreakerError(message="Circuit breaker is open", service_name="external_api")
...
class TestDomainSpecificErrors:
    ...
    def test_configuration_error(self):
        ...
        exc = ConfigurationError(message="Invalid configuration", config_key="database_url")
    ...
    def test_cache_error(self):
        ...
        exc = CacheError(
            message="Cache operation failed", cache_key="user:123", correlation_id="test-id"
        )
    ...
    def test_tws_connection_error(self):
        ...
        exc = TWSConnectionError(message="TWS connection failed", details={"host": "api.tws.com"})
    ...
    def test_llm_error(self):
        ...
        exc = LLMError(message="LLM request failed", model_name="gpt-4", details={"tokens": 1500})
    ...
    def test_file_processing_error(self):
        ...
        exc = FileProcessingError(
            message="Failed to process file", filename="document.pdf", details={"size": "10MB"}
        )
...
class TestExceptionChaining:
    ...
    def test_exception_chain_in_dict(self):
        ...
        original = ValueError("Original error")
        exc = ValidationError(
            message="Validation failed", original_exception=original, correlation_id="test-id"
        )
