...
class TestTWSValidatorsIntegration:
    ...
    def test_dependency_chain_complex(self):
        ...
        data = {
            ...
            "dependencies": [
                {
                    "from_job": "ETL_EXTRACT",
                    "to_job": "ETL_TRANSFORM",
...
class TestRAGCrossEncoderIntegration:
    ...
    def test_empty_documents_handling(self):
        ...
        from resync.knowledge.retrieval.reranker import RerankResult, rerank_documents
    ...
    def test_rerank_result_structure(self):
        ...
        from resync.knowledge.retrieval.reranker import RerankResult
...
class TestPerformance:
    ...
    def test_validator_performance(self):
        ...
        # Prepare test data
        test_data = [{"job_name": f"JOB_{i}", "status": "SUCC", "rc": 0} for i in range(100)]
