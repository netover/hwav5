...
class TestAgentRouter:
    ...
    def mock_agent_manager(self):
        ...
        manager.get_agent = AsyncMock(return_value=MagicMock(
            arun=AsyncMock(return_value="Agent response")
        ))
        return manager
...
class TestStatusHandler:
    ...
    def mock_agent_manager(self):
        ...
        manager.get_agent = AsyncMock(return_value=MagicMock(
            arun=AsyncMock(return_value="Fallback response")
        ))
        return manager
...
class TestTroubleshootingHandler:
    ...
    def mock_agent_manager(self):
        ...
        manager.get_agent = AsyncMock(return_value=MagicMock(
            arun=AsyncMock(return_value="Recommendation: Check logs")
        ))
        return manager
    ...
    async def test_handle_analyzes_failures(self, handler):
        ...
        classification = IntentClassification(
            primary_intent=Intent.TROUBLESHOOTING,
            confidence=0.9,
            entities={}
        )
...
class TestRouterIntegration:
    ...
    def mock_agent_manager(self):
        ...
        manager.get_agent = AsyncMock(return_value=MagicMock(
            arun=AsyncMock(return_value="Agent processed your request")
        ))
        return manager
