...
down_revision = "20241210_0001_001_initial_schema_initial_schema"
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    # Create indexes
    op.create_index(
        "idx_admin_users_username", "admin_users", ["username"], schema="core"
    )
    ...
    op.create_index(
        "idx_admin_users_is_active", "admin_users", ["is_active"], schema="core"
    )
